...
mkdirSync('app/api/admin/create-user', { recursive: true });

writeFileSync('app/api/admin/create-user/route.ts', `import { NextRequest, NextResponse } from "next/server";
...
console.log('Created create-user API successfully!');