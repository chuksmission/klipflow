...
export default function Studio() {
  ...
  const tokenCostRef = useRef<number>(10);
  const selectedModelRef = useRef<string>("kling-v1");
  ...
  const models: Model[] = [
    { id: "kling-v1", name: "Kling v1", desc: "Fast and affordable", tokens: 10, badge: "", available: true },
    ...
    { id: "sora", name: "OpenAI Sora", desc: "Creative and surreal", tokens: 25, badge: "Coming Soon", available: false },
  ];

  const modules: Module[] = [
    { id: "text_to_video", icon: "TTV", title: "Text to Video", desc: "Generate cinematic videos from text descriptions", badge: "Most Popular" },
    { id: "image_to_video", icon: "ITV", title: "Image to Video", desc: "Animate any still image into a stunning video", badge: "" },
    ...
    { id: "prompt", icon: "EXP", title: "Prompt Expander", desc: "Transform ideas into cinematic prompts", badge: "" },
    { id: "script", icon: "SCR", title: "Script Writer", desc: "Generate viral video scripts", badge: "" },
  ];
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 mb-2">
                  <button
                    ...
                    className={"px-3 py-1.5 rounded-full text-xs font-bold transition " + (!useUrl ? "bg-purple-600 text-white" : "bg-white/10 text-gray-400")}
                  >
                    Upload Image
                  </button>
                  <button
                ...
                {(selectedModel === "kling-v2" || selectedModel === "kling-v3") && (
                  <div className="bg-green-900/20 border border-green-500/20 rounded-xl px-4 py-3">
                    <p className="text-green-400 text-xs font-semibold">
                      Sound included with {selectedModel === "kling-v2" ? "Kling v2" : "Kling v3"}
                    </p>
                  </div>
                )}
              </>
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-4">
          ...
          <div className="bg-blue-900/20 border border-blue-500/20 rounded-xl p-3">
            ...
            <p className="text-gray-400 text-xs">
              Tap and hold the video, then select Save to Photos or use the Share button.
            </p>
          </div>
        </div>
      )}
...
const generateVideoRoute = `import { NextRequest, NextResponse } from "next/server";
...
writeFileSync("app/dashboard/studio/page.tsx", studioPage, "utf8");
console.log("Written: app/dashboard/studio/page.tsx");

writeFileSync("app/api/generate-video/route.ts", generateVideoRoute, "utf8");
console.log("Written: app/api/generate-video/route.ts");

console.log("\nAll done! Run: git add . && git commit -m \"Fix studio TypeScript\" && git push");
