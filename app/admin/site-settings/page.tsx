...
export default function AdminSiteSettings() {
  ...
  const fields = [
    { key: "site_name", label: "Site Name", placeholder: "KlipflowAI", secret: false },
    { key: "site_url", label: "Site URL", placeholder: "https://klipflowai.com", secret: false },
    { key: "support_email", label: "Support Email", placeholder: "support@klipflowai.com", secret: false },
    { key: "free_trial_tokens", label: "Free Trial Tokens", placeholder: "25", secret: false },
    { key: "max_accounts_per_device", label: "Max Accounts Per Device", placeholder: "3", secret: false },
  ];
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-extrabold mb-1">Site Settings</h1>
