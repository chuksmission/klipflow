...
export default function AdminAIProviders() {
  ...
  const providers = [
    ...
    },
    {
      name: "OpenAI",
      icon: "??",
      desc: "GPT-4 for scripts, prompt expansion and Sora for video",
      fields: [
    ...
    },
    {
      name: "Runway",
      icon: "??",
      desc: "Runway Gen-4 video generation",
      fields: [
    ...
    <div className="space-y-6 max-w-3xl">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 text-sm">Manage API keys for all AI models</p>
        </div>
        <button
          onClick={handleSave}
          disabled={saving}
